                                ...
                                <div class="section_body">
                                    <div class="survey_container" id="survey_container">
                                        <div class="row survey_container_row">
                                            <div type="-5" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 survey_row_title_container" data-survey-id="{{$survey->id}}"
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section_row_title_container" data-survey-id="{{$section->id}}"
                                                 data-route="{{route('users.surveys.sections.show',['user' =>$username, 'survey'=>md5($survey->id), 'section'=>$section->id])}}">
