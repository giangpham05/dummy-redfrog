            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    @foreach($survey->sections as $key=>$section)
                        ...
                        <div tabindex="6" class="row addNewSection_row" style="margin-top: 10px;margin-bottom: 10px;" data-route="{{route('users.surveys.sections.create',['user' =>$username, 'survey'=>md5($survey->id)])}}">
                            <div class="addNewSection col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 12px; padding-bottom: 12px">
                                <a class="new_section" href="#">
