...
@section('css')
    ...
    {{--@yield('allSurveyCss')--}}
    {{--<!-- Morris Chart Css-->--}}
    {{--<link href="{{ URL::asset('src/assets/plugins/morrisjs/morris.css')}}" rel="stylesheet" />--}}
...
@section('main')
    <section class="content">
        ...
        @include('manage.includes.block-header', ['title' => 'DASHBOARD', 'icon'=>'home'])
...
@section('script')
    ...
    {{--<script type="text/javascript" src="{{ URL::asset('src/assets/js/pages/index.js') }}"></script>--}}
